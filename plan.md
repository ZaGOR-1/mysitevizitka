...
Це дає готову основу для майбутнього theme switcher у `script.js`.
...
- підключення майбутнього `script.js`.
...
Їх використає `script.js` у Фазі 6.
...
Додати мінімальний JS у `script.js` тільки для потрібної інтерактивності.
...
`script.js` містить короткий, зрозумілий і легко редагований код.
...
**Виконано.** Створено `script.js` із мінімальною прогресивною інтерактивністю: theme switcher, mobile menu, smooth scroll, reveal animation і dynamic footer year.

### Реалізовані рішення у `script.js`
...
- `node --check .\script.js` проходить без синтаксичних помилок;
...
9. Написати мінімальний `script.js`.
