...
Навички згруповані за рівнем практики:

```html
<dl class="skill-table">
  <div class="skill-row">
    <dt>Практикую</dt>
    <dd>HTML, CSS, JavaScript, PHP, Linux</dd>
  </div>
</dl>
```

Можна змінювати рівні, список технологій або додавати нові `.skill-row`. Поточна логіка: `Практикую`, `Вчу`, `Знайомий з`.
